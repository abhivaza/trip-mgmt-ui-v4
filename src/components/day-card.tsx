...
export const DayCard = ({ day, tripId, itinerary, setItinerary }: DayCardProps) => {
  ...
  const generateAIContent = async () => {
    ...
    try {
      const response = await api.post<{ place: string }, ItineraryDayActivity>(`/app/trip/${tripId}/day/generate`, {
        place: day.place,
      })
      ...
      <CardContent>
        <div className="flex flex-col md:flex-row gap-6">
          <div className="flex-1">
            ...
            <div className="mt-2">
              <Button variant="link" onClick={() => handleEditActivity(day)} className="p-0 h-auto mt-1">
          ...
          <div className="flex-1">
            <TripSections tripId={tripId} place={day.place} />
          </div>
        </div>
      </CardContent>
